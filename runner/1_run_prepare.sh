#!/bin/bash
#SBATCH --job-name=1_Prepare         # Nom du job
#SBATCH --output=logs/prepare_output.log    # Fichier de sortie standard
#SBATCH --error=logs/prepare_error.log      # Fichier d'erreur
...
python app/config/1_prepare.py
echo "=== Fin AutoML ==="
