#!/bin/bash
#SBATCH --job-name=6_migration         # Nom du job
#SBATCH --output=logs/migration_output.log    # Fichier de sortie standard
#SBATCH --error=logs/migration_error.log      # Fichier d'erreur
